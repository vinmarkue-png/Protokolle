...
The measured diffusion constants $D_{\mathrm{NaCl}} = 1.414 \times 10^{-9}\,\mathrm{m^2\,s^{-1}}$, $D_{\mathrm{KCl}} = 6.636 \times 10^{-9}\,\mathrm{m^{2}\,s^{-1}}$ and $D_{\mathrm{ZnSO4}} = 2.925 \times 10^{-10}\,\mathrm{m^{2}\,s^{-1}}$ deviate from the ones obtained from literature sources wich were. \\
