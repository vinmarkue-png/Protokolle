...
The absolute uncertainty of the diffusion coefficient $\sigma_D$ is derived from the linear relationship in \autoref{gleichungm} through error propagation of the slope, yielding $\sigma_D = D \cdot (s_m/m)$. For the investigated samples, this results in the following values: For \ch{NaCl}, the absolute deviation is $\sigma_{D,\mathrm{NaCl}} = 2.97 \cdot 10^{-11}\,\mathrm{m^2\,s^{-1}}$, leading to a final result of $D_{\mathrm{NaCl}} = (1.41 \pm 0.03) \cdot 10^{-9}\,\mathrm{m^2\,s^{-1}}$. For \ch{KCl}, an uncertainty of $\sigma_{D,\mathrm{KCl}} = 7.78 \cdot 10^{-11}\,\mathrm{m^2\,s^{-1}}$ leads to $D_{\mathrm{KCl}} = (2.88 \pm 0.08) \cdot 10^{-9}\,\mathrm{m^2\,s^{-1}}$. The measurement of \ch{ZnSO4} yields an uncertainty of $\sigma_{D,\mathrm{ZnSO4}} = 9.95 \cdot 10^{-12}\,\mathrm{m^2\,s^{-1}}$, resulting in $D_{\mathrm{ZnSO4}} = (2.93 \pm 0.10) \cdot 10^{-10}\,\mathrm{m^2\,s^{-1}}$.
...
The diffusion constants of \ch{NaCl}, \ch{KCl} and \ch{ZnSO4} were determined as $D_{\mathrm{NaCl}} = (1.41 \pm 0.03) \cdot 10^{-9}\,\mathrm{m^2\,s^{-1}}$, $D_{\mathrm{KCl}} = (2.88 \pm 0.08) \cdot 10^{-9}\,\mathrm{m^2\,s^{-1}}$ and $D_{\mathrm{ZnSO4}} = (2.93 \pm 0.10) \cdot 10^{-10}\,\mathrm{m^2\,s^{-1}}$ by using the Schlieren method. Most deviations from literature values can be explained by mistakes during the conduction of the experiment or errors in the setup.
\newpage
