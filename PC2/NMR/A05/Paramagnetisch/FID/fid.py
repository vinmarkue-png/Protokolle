...
dateipfad = r"C:\Users\vinma\Documents\Chemie Studium\5. Semester\Protokolle\PC2\NMR\A05\Paramagnetisch\FID\fid_pcii_FID.txt"
...
plt.plot(zeit_ms, intensitaet, linewidth=1, color='black')
