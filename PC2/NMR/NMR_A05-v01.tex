...
Wechselwirkungen und elektronische Effekte in chemischen Verbindungen können zu Aufspaltungen oder Verschiebungen führen. Zu nennen sind hier vor allem die chemische Verschiebung $\delta$, welche von der elektronischen Umgebung des betreffenden Kernes abhängt und zu einer chemischen Verschiebung dessen Resonanzfrequenz $\nu$ führt. Diese berechnet sich nach \autoref{eq: verschiebung} mit der Resonanzfrequenz $\nu_{\text{Ref}}$ der Referenzsubstanz.
\begin{equation}
\delta = \frac{\nu_{\text{Probe}} - \nu_{\text{Ref}}}{\nu_{\text{Ref}}}
