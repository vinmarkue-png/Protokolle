...
Im dritten Versuchsteil wurden die Probe \ch{CFCl3}, eine \ch{CFCl3}/\ch{C6H11F}-Mischung sowie Perfluortributylamin mit der Messapplikation ,,fluor\_ft\_pcII'' und den gleichen Parametern wie im Daily-Check, aber einem Receiver Gain von 79 dB vermessen. Das für jede Probe aufgenommene FID-Signal wurde anschließend fourier-transformiert, um die entsprechenden \ch{^{19}F}-NMR-Spektren zu erhalten und die chemische Verschiebung der Signale zu bestimmen.
...
\begin{figure}[H]
    ...
    \label{wasser90}
\end{figure}
Im Plot sind nun zwei Signale zu sehen, die sich auf Grund der Änderung des Gradienten in ihrer Intensitätunterscheiden. Das kommt daher, dass die Proben nach der Drehung hintereinander in der Richtung des Gradienten liegen und deshalb eine unterschiedliche Magnetfeldstärke erfahren. 
\newpage
\subsubsection{2D-NMR}
