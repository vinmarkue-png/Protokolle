...
\begin{figure}[H]
    ...
    \label{wasser90}
\end{figure}
Im Plot sind nun zwei Signale zu sehen, die sich auf Grund der Änderung des Gradienten in ihrer Intensität unterscheiden. Das kommt daher, dass die Proben nach der Drehung hintereinander in der Richtung des Gradienten liegen und deshalb eine unterschiedliche Magnetfeldstärke erfahren. 
\newpage
\subsubsection{2D-NMR}
