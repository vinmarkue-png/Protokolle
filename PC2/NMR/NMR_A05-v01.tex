...
\begin{figure}[H]
    ...
    \caption{Gemessenes NMR-Spektrum .} 
    \label{h_seit}
\end{figure}
Im Spektrum sind die einzelnen Schichten in denen Wasserstoffatome detektiert wurden farblich ihrer
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{A05/Bildgebung/Probe 2/Probe2_unten.png}
    \caption{Gemessenes NMR-Spektrum .} 
    \label{h_unt}
\end{figure}
\subsection{Chemische Verschiebung}
