...
\begin{figure}[H]
    ...
    \label{wasser90}
\end{figure}
Im Plot sind nun zwei Signale zu sehen. Das kommt daher, dass die Proben nach der Drehung hintereinander in der Richtung des Gradienten liegen und deshalb eine unterschiedliche Magnetfeldstärke erfahren. 
\newpage
\subsubsection{2D-NMR}
...
\begin{figure}[H]
    ...
    \label{h_seit}
\end{figure}
Im Plot/der Abbildung sind die einzelnen Schichten in denen Wasserstoffatome detektiert wurden, farblich ihrer Intensität und damit ihrer Spindichte nach markiert. Es wird ersichtlich, dass die Probe in der Mitte die höchste Spindichte hat, was darauf deuten lässt, dass sich dort das Wasser im Probenröhrchen befindet. \autoref{h_ob} zeigt das gleiche Plot/die Abbildung von oben. 
\begin{figure}[H]
    \centering
