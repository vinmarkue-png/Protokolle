...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Chloro/chloro_transmission.pdf}
    \caption{The transmission spectra of the five measured chlorophyll solutions} 
    \label{fig: Chloro_trans}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Chloro/chloro_absorption.pdf}
    \caption{The absorbance spectra of the five measured chlorophyll solutions} 
