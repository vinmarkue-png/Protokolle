...
To evaluate all following spectra a calibration spectrum of the light source and its filter was taken and plotted in \autoref{fig: filter}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{filter/plot_mit_und_ohne_filter.pdf}
    \caption{The intensities of the measuring setup with and without the badpass filter.} 
    \label{fig: filter}
\end{figure}
