...
Since chlorophyll spectra of different concentrations were measured, these can now be compared. The absorptions of the different concentrations are plotted together in \autoref{fig: Chloro_abs}, as this allows for the most effective analysis and comparison of the spectral features. By overlaying the absorption curves, the linear increase in peak intensity relative to the concentration becomes evident, consistent with the Beer-Lambert's law. This simultaneous representation also confirms that the positions of the characteristic absorption maxima remain constant, indicating that no significant chemical alterations or aggregation effects occurred within the studied concentration range.
