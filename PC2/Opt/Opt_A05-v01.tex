...
Chlorophyll concentration series were evaluated, confirming the Beer-Lambert law while identifying detector saturation and stray light as primary sources of spectral deviation.
...
To evaluate the measuring setup the spectrum of the used lightsource with and without filter is plotted in \autoref{fig: filter}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{filter/plot_mit_und_ohne_filter.pdf}
    \caption{The intensities of the measuring setup plotted over the number of steps with and without the badpass filter.} 
    \label{fig: filter}
\end{figure}

Using \autoref{eq: alpha2} the number of steps is converted into the wavelength $\lambda$. To adjust the paramers of the parameter scale, $f$ and $\Delta \alpha$ the transmission of said bandpassfilterwas plotted over the wavelength together with the transmission spectrum for a theoretical, ideal bandpassfilter. The values were adjusted as in chapter 2 described. As a result of the adjustment the two spectra are plotted in \autoref{fig: filter2}.
...
In the transmission spectrum, a clear minimum is observed at approximately $525$ nm. It should be noted that the characteristic purple color of the permanganate solution does not correspond to the absorbed wavelength, but rather to its complementary color. This phenomenon occurs because the absorption of the green component from the incident white light leaves the remaining spectral colors to be perceived by the observer. The corresponding absorbance spectrum of permanganate is presented in \autoref{fig: KMnO4_abs}.
...
\section{Conclusion}
In this experiment, a DIY spectrometer with a rotatable grating was used to measure the absorption spectra of different samples, including potassium permanganate, chlorophyll and holmium oxide in nitric acid. The spectrometer was calibrated using a bandpass filter and the measured spectra were analyzed to extract information about the absorption peaks of the samples.
...
The potassium permanganate spectra reveal a characteristic absorption maximum at $525$\,nm, where the observed purple color originates from the absorption of the green spectral component via a ligand-to-metal charge transfer (LMCT).

The concentration series of chlorophyll demonstrates a proportional increase in absorbance according to the Beer-Lambert law, though detector saturation and stray light effects cause the experimental spectra to deviate from the ideal literature gap between $500$\,nm and $600$\,nm.
