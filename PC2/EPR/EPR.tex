...
\begin{equation*}
g_{\mathrm{Cu(AcAc)_2},1} = \frac{\SI{6,6261e-34}{Js} \cdot \SI{9,42368e9} {\hertz} }{\SI{9,2741e-24}{\frac{J}{T}} \cdot \SI{317,2}{\milli\tesla}} = 2{,}1226
\end{equation*}

Desweiteren lässt sich der $g$-Faktor auch wie in Gleichung \ref{eq: gx} berechnen, bei der $g$-Faktor und Magnetfeld des internen Standard mit einbezogen wird.

\begin{equation*}
g_{\mathrm{Cu(AcAc)_2},2} = 2,0022 \cdot \frac{\SI{336,742}{\milli\tesla}}{\SI{317,2}{\milli\tesla}}
\end{equation*}
