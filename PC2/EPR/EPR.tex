...
Das aufgenommene ESR-Spektrum von Kupfer(II)acetylacetonat \ch{Cu(AcAc)2}  ist in Abbildung \ref{fig: Cu} dargestellt, dabei ist anzumerken, dass der Korekturfaktor hier bereits miteinberechnet worden ist.
...
Die Positionen der Peaks, die sich der Kupferprobe zuordnen lassen liegen bei $B_{1,\text{Cu}} \approx 304,9 $ mT, $B_{2,\text{Cu}} \approx 313,2 $ mT, $B_{3,\text{Cu}} \approx 321,5 $ mT und $B_{4,\text{Cu}} \approx 329,7 $ mT. Das Spektrum der Kupferprobe ist hierbei um den Mittelwert von dem ersten und dem letzten Peak der Kupferprobe zentriert. Dieses Zentrum des Spektrums berechnet sich wie folgt:

\begin{equation*}
\bar{B_{\text{Cu}}} = \frac{\SI{329,7}{\milli\tesla} + \SI{304,9}{\milli\tesla}}{2} = \SI{317,2}{\milli\tesla}
\end{equation*}

Das Spektrum der Kupferprobe ist somit um den den Wert von $ \bar{B_{\text{Cu}}} = \SI{317,2}{\milli\tesla} $ zentriert.

Ausgehend von diesem Magnetfeld kann nun der $g$-Faktor und der Mikrowqellenfrequenz $ \nu \approx \SI{9,44e9} {\hertz}$ gemäß Gleichung \ref{eq: gB} errechnet werden: 
\begin{equation*}
g_{\text{Cu, Gl.1}} = \frac{\SI{6,6261}{\joule\sec} \cdot \SI{9,44e9} {\hertz} }{\SI{9,2741e-24}{\joule\per\tesla} \cdot \SI{317,2}{\milli\tesla}} \approx 2,126
\end{equation*}
...
In Abbildung \ref{fig: Vo} ist das ESR-Spektrum der Vanadylacetylacetonat-Probe mit ebenfalls DPPH als internem Standard zu sehen. 
...
Cu(AcAc)$_2$ + DPPH 9,44 & 317,2 & 0,0078 &  \\
VO(AcAc)$_2$ + DPPH  &  &  &   \\
Galvinoxyl           &  &  & 
\end{tabular}
\label{tab: fehler}
