...
In \autoref{fig: DPPH-modul-var} lässt sich erkennen, dass die Spektrenhöhe mit zunehmender Modulationsamplitude ansteigt. %Die Linienbreite nimmt bis zu einer Modulationsamplitude von 32 mT ab, aber steigt im Spektrum mit Amplitude von 64 mT wieder an.
...
Durch Einsetzen des Bohrschen Magnetons $\mu_\mathrm{B}$ und des Planck'schen Wirkungsquantum zusammen mit dem Spektrenzentrum und der Frequenz in die umgestellte Gleichung der Resonanzbedingung \ref{eq:resonanz} wird der g-Faktor berechnet.
\begin{align*}
	g &= \frac{h \cdot \nu}{\mu_\mathrm{B} \cdot B_0} \\
	&= \frac{\SI{6.6261e-34}{Js} \cdot \SI{9,43402e9}{Hz}}{\SI{9,2741e-24}{JT^{-1}} \cdot \SI{336,656e-3}{T}} \\
	&= 2{,}0022
\end{align*}
Mit dem Literaturwert von DPPH von $g_{\mathrm{Lit}} = 2{,}0037$ ergibt sich eine absolute Abweichung von 0,0015. Die Ungenauigkeit des g-Faktors wird in der Fehlerrechnung bestimmt.
