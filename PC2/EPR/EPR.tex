...
\vspace{1cm}
\textbf{Abstract:}
In diesem Versuch wurde der Einfluss der verschiedenen Parameter bei der ESR-Spektroskopie durch Messung einer DPPH-Probe gezeigt. Anschließend wurde der $g$-Faktor von DPPH als $g_\mathrm{DPPH} = 2{,}0022 \pm 0{,}0045$ bestimmt. Außerdem wurden Spektren der beiden Übergangsmetallkomplexe Kupfer(II)acetylacetonat und Vanadylacetylacetonat aufgenommen, aus denen deren $g$-Faktoren als $g_{\mathrm{Cu(AcAc)_2}} = 2{,}13048 \pm 0{,}0048$ und $g_{\mathrm{VO(AcAc)_2}} = 1{,}98110\pm 0{,}0044$ bestimmt. Ebenfalls wurden die Hyperfeinstrukturkopplungskonstanten $\bar{a_{\text{Cu}}} = 8,27$ und $\bar{a_{\text{Vo}}} = 10,86$ bestimmt. Zum Schluss wurde das Galvinoxylradikal sowohl durch Messung als auch Simulation untersucht. Dabei wurden die Parameter der Simulation so angepasst, dass die Simulation möglichst nah an den idealen Werten liegt. 
...
Die Positionen der Peaks, die sich der Kupferprobe zuordnen lassen, liegen bei 
$B_{1,\text{Cu}} \approx \SI{303,622}{mT}$, $B_{2,\text{Cu}} \approx \SI{311,982}{mT}$, 
$B_{3,\text{Cu}} \approx \SI{320,192}{mT}$ und $B_{4,\text{Cu}} \approx \SI{328,432}{mT}$. 
Das Spektrum der Kupferprobe ist hierbei um den Mittelwert von dem ersten und dem 
letzten Peak der Kupferprobe zentriert. Dieses Zentrum des Spektrums berechnet sich wie folgt:

\begin{equation*}
\overline{B_{\text{Cu}}} = \frac{\SI{328,432}{\milli\tesla} + \SI{303,622}{\milli\tesla}}{2} = \SI{316,03}{\milli\tesla}
\end{equation*}
...
\begin{equation*}
g_{\mathrm{Cu(AcAc)_2},1} = \frac{\SI{6,6261e-34}{Js} \cdot \SI{9,42368e9} {\hertz} }{\SI{9,2741e-24}{\frac{J}{T}} \cdot \SI{316,03}{\milli\tesla}} = 2,13048
\end{equation*}

Desweiteren lässt sich der $g$-Faktor auch wie in Gleichung \ref{eq: gx} berechnen, bei der $g$-Faktor und Magnetfeld des internen Standard mit einbezogen wird. Der DPPH Peak liegt hier bei $B = 336,66$ mT

\begin{equation*}
g_{\mathrm{Cu(AcAc)_2},2} = 2,0037 \cdot \frac{\SI{336,66}{\milli\tesla}}{\SI{316,03}{\milli\tesla}} = 2,13445
\end{equation*}
...
\begin{table}[htbp]
    \centering
    \caption{Berechnete Kopplungskonstante $a$ aus den korrigierten Feldstärkedifferenzen der Kupfer-Peaks ($Cu(AcAc)_2$). Die Korrektur erfolgte durch Subtraktion von $1,258\,\text{mT}$.}
    \label{tab:kopplungskonstante}
    \begin{tabular}{cccc}
        \hline
        Peak-Paar & $B_{n}$ [mT] & $B_{n+1}$ [mT] & $a$ [mT] \\ \hline
        1 \& 2    & 303,622            & 311,982              & 8,36     \\
        2 \& 3    & 311,982            & 320,192              & 8,21     \\
        3 \& 4    & 320,192            & 328,432              & 8,24     \\ \hline
       $ \bar{a}$ &          &                      & 8,27 \\ \hline
    \end{tabular}
\end{table}

Die Kopplungskonstante $\bar{a_{\text{Cu}}}$ beträgt für das \ch{Cu(AcAc)2} dementsprechend $\bar{a_{\text{Cu}}} = 8,27\,\text{mT}$.
...
Die große Peak in der Mitte ist hier wieder dem DPPH-Standard zuzuweisen, die Positionen der acht verbleibenden Peaks der Vanadylacetylacetonat-Probe sind in Tabelle \autoref{tab: bfeld} dargestellt.

\begin{table}[htbp]
    \centering
    \caption{Magnetfeldpositionen der acht Hyperfeinpeaks von $VO(AcAc)_2$ und der berechnete Mittelwert dieser.}
    \label{tab: bfeld}
    \begin{tabular}{cc}
        \hline
        Peak Nr. & $B$ [mT] \\ \hline
...
Analog zur Kupferprobe kann damit nun nach \autoref{eq: gB} ein $g$-Faktor von $g_{\mathrm{VO(AcAc)_2},1} = 1,9908$ berechnet werden.
Nach Gleichung \autoref{eq: gx} mit einer DPPH-Peakposition von $B = 336,15$ mT ergibt sich ein $g$-Faktor von  $g_{\mathrm{VO(AcAc)_2},1} = 1,98110$
...
\begin{table}[htbp]
    \centering
    \caption{Berechnete Kopplungskonstante $a$ aus den jeweiligen Feldstärkedifferenzen der Vanadium-Peaks ($VO(AcAc)_2$).}
    \label{tab avo}
    \begin{tabular}{ccc}
        \hline
        ...
        344,52     & 355,67     & 11,15    \\
        355,67     & 367,23     & 11,56    \\
        367,23     & 378,94     & 11,71    \\ \hline
        $\bar{a}$  &            & 10,86    \\ \hline
    \end{tabular}
\end{table}

Die Kopplungskonstante $a$ beträgt für das \ch{VO(AcAc)2} dementsprechend $\bar{a_{\text{Vo}}} = 10,86\,\text{mT}$.
...
\begin{equation*}
    g = \frac{h \cdot \nu}{\mu_0 \cdot B_0} = \frac{\SI{6,626 e-34}{Js} \cdot \SI{9,45544 e9}{Hz}}{\SI{9,2740 e-24}{\frac{J}{T} \cdot \SI{336,25 e-3}{T}}} = 2,0091
\end{equation*}
...
Im zweiten Versuchsteil wurden die $g$-Faktoren, so wie die Hyperfeinstrukturkopplungskonstanten $a$ erfolgreich zu \\
$g_{\mathrm{Cu(AcAc)_2}} = 2{,}13048 \pm 0{,}0048$ $\bar{a_{\text{Cu}}} = 8,27$ \\
$g_{\mathrm{VO(AcAc)_2}} = 1{,}98110\pm 0{,}0044$ $\bar{a_{\text{Vo}}} = 10,86$\\ bestimmt werden.
