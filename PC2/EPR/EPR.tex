...
\vspace{1cm}
\textbf{Abstract:}
In diesem Versuch konnte der Einfluss der verschiedenen Parameter bei der ESR-Spektroskopie durch Messung einer DPPH-Probe gezeigt werden. Außerdem wurden Spektren der beiden Übergangsmetallkomplexe Kupfer(II)acetylacetonat und Vanadylacetylacetonat aufgenommen, aus denen deren $g$-Faktoren, so wie die Hyperfeinstrukturkopplungskonstante bestimmt werden konnte. Schließlich wurde das Galvinoxylradikal sowohl durch Messung als auch Simulation untersucht, wobei die Parameter der Simulation so angepasst wurden, dass die Simulation möglichst nah an der realen Messung liegt.
