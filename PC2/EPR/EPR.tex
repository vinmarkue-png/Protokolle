...
DPPH - modul. var.    & 337,91 & 1,3   & 0,01 - 0,64    & 20     & $3\cdot10^{1}$ \\
\hline
...
\autoref{fig: DPPH-start} zeigt die aufgenommenen ESR-Spektren der DPPH-Probe zwischen 20 dB und 5 dB mit Verdopplung der Mikrowellenleistung jeder Probe in 3 dB Schritten.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{DPPH/B)/DPPH_MW_Attenuation.pdf}
    \caption{ESR-Spektrum der DPPH-Probe mit variierender MW attenuation zwischen 20 dB und 5 dB.} 
...
\begin{figure}[H]
    ...
    \caption{ESR-Spektrum der DPPH-Probe .} 
