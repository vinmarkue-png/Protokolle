...
Die schon vorbereiteten Proben wurden im ESR-Spektrometer untersucht, hierfür wurden die in \autoref{tab: parameter} gelisteten Parameter verwendet.
...
\begin{equation*}
g_{\mathrm{Cu(AcAc)_2},2} = 2{,}0037 \cdot \frac{\SI{336{,}66}{\milli\tesla}}{\SI{316{,}03}{\milli\tesla}} = 2{,}1345
\end{equation*}
...
Analog zur Kupferprobe kann damit nun nach \autoref{eq: gB} ein $g$-Faktor von $g_{\mathrm{VO(AcAc)_2},1} = 1{,}9811$ berechnet werden.
...
Cu(AcAc)$_2$ + DPPH & 9,42368 & 316,03 & 0,0048 \\
VO(AcAc)$_2$ + DPPH  & 9,42368 & 339,86 &  0,0044 \\
