...
# plt.plot(x1c, y1, label=r"Galvinoxyl + DPPH: mit O$_2$", lw=0.5, color = "black")
plt.plot(x4c, y4, label=r"Galvinoxyl + DPPH: entgast", lw=0.5, color="black")
