...
\begin{table}[H]
    ...
    \hline
    1 & 755.02 & 0.18 & \\
    2 & 775.42 & 0.51 & asym. stretching \\
    3 & 799.91 & 0.18 & \\
    4 & 903.98 & 0.88 & asym. stretching \\
    5 & 1122.32 & 0.03 & \\
    6 & 1354.95 & ~0.01 & \\
    \end{tabular}
    \label{tab: C2Cl4}
...
In comparison to the simulated IR spectrum of chloroform with the wavenumbers and vibrational modes in \autoref{tab: CHCl3}, tetrachloroethylene shows additional IR-active modes in the low wavenumber region below 500 cm$^{-1}$, which can be attributed to the increased number of atoms in the molecule leading to more vibrational modes. Furthermore, tetrachloroethylene 
...
In comparison to the calculated IR-active modes in \autoref{tab: C2Cl4_sim}, the Raman-active modes in \autoref{tab: raman_C2Cl4_sim} show a different pattern, with the most intense Raman-active mode found at a wavenumber of 1623.90 cm$^{-1}$, which does not correspond to any of the most intense IR-active modes.
