...
For the comparison of the \ch{C-Cl} and \ch{C-Br} force constants, the reduced masses $\mu$ for both bonds are calculated using \autoref{eq:mu}.
\begin{equation*}
...
\begin{align*}
    k_{\mathrm{C-Cl}} &= \left(2\pi \cdot \SI{703.86}{cm^{-1}} \cdot \SI{2.99 e10}{\frac{cm}{s}}\right)^2 \cdot \SI{8.97}{\frac{g}{mol}}\\
    &= \SI{1.568 e29}{\frac{g}{mol \cdot s}}
\end{align*}
...
\begin{align*}
    k_{\mathrm{C-Br}} &= \left(2\pi \cdot \SI{574.64}{cm^{-1}} \cdot \SI{2.99 e10}{\frac{cm}{s}}\right)^2 \cdot \SI{10.43}{\frac{g}{mol}}\\
    &= \SI{1.216 e29}{\frac{g}{mol \cdot s}}
\end{align*}
...
\begin{equation*}
    \mu_{\mathrm{C-H}} = \frac{\SI{12}{\frac{g}{mol}} \cdot \SI{1}{\frac{g}{mol}}}{\SI{12}{\frac{g}{mol}} + \SI{1}{\frac{g}{mol}}} = \SI{0.923}{\frac{g}{mol}}
\end{equation*}
\begin{equation*}
    \mu_{\mathrm{C-D}} = \frac{\SI{12}{\frac{g}{mol}} \cdot \SI{2}{\frac{g}{mol}}}{\SI{12}{\frac{g}{mol}} + \SI{2}{\frac{g}{mol}}} = \SI{1.714}{\frac{g}{mol}}
\end{equation*}
...
\begin{equation*}
    ...
    \sqrt{\frac{\mu_{\mathrm{C-D}}}{\mu_{\mathrm{C-H}}}} = \sqrt{\frac{\SI{1.714}{\frac{g}{mol}}}{\SI{0.923}{\frac{g}{mol}}}} = 1.363
\end{equation*}
...
\begin{equation*}
    \frac{\tilde{\nu}_{\mathrm{C-H}}}{\tilde{\nu}_{\mathrm{C-D}}} = \frac{\SI{3015.32}{cm^{-1}}}{\SI{2248.93}{cm^{-1}}} = 1.341 
\end{equation*}
The ratio of the measured wavenumbers of 1.341 only shows a small deviation from the theoretical value of 1.363, confirming the dependence of the reduced mass on the wavenumbers of the \ch{C-H}  and \ch{C-D} stretching vibrations in the Raman spectra.
\newpage
\section{Conclusion}
