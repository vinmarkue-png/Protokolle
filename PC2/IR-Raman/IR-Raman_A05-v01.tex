...
\begin{table}[H]
    \centering
    \caption{Listed are the measured wavenumbers and intensities of the IR signals of \ch{CH2Cl2} with the corresponding type of the vibrational mode.\ch{CH2Cl2}.}
    \begin{tabular}{c|c|c|c}
