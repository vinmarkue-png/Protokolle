...
The measured Raman spectrum of chloroform is shown in \autoref{fig: CHCl3_Ram_Ram}, plotting the Raman intensity against the Raman shift $\Delta \tilde{\nu}$.
...
The simulated Raman-active vibrational modes of chloroform are summarized in \autoref{tab: raman_CHCl3_sim} with the corresponding Raman shift, Raman intensity and vibration type of each mode.
...
\begin{table}[H]
    ...
    7 & 447.02 & 0.00 & \\
    8 & 514.19 & 0.00 & \\
    9 & 774.46 & 82.16 & asym. C-Cl stretch \\
    10 & 895.52 & 202.05 & asym. C-Cl stretch \\
    11 & 978.50 & 0.00 & 
    \label{tab: C2Cl4_sim}
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    7 & 446.81 & 15.61 & \\
    8 & 517.38 & 3.22 & \\
    9 & 774.24 & 0.00 & asym. C-Cl stretch \\
    10 & 895.62 & 0.00 & asym. C-Cl stretch \\
    11 & 978.54 & 0.44 & \\
...
\end{figure}
The first trend noticeable in \autoref{fig: raman_trends} is the decrease of the Raman shifts with increasing number of chlorine atoms in the molecule. This can be explained by the increasing reduced mass $\mu$ of the molecules due to the substitution of hydrogen atoms (mass = 1 u) with chlorine atoms (mass = 35.5 u), leading to lower vibrational frequencies $\tilde{\nu}$ according to \autoref{eq: nu}.
\begin{equation}
    \tilde{\nu} = \nu \cdot c = \sqrt{\frac{k}{\mu}}
    \label{eq: nu}
\end{equation}
