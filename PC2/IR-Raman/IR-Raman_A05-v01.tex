...
The Raman signal of the asymmetric C-H stretching vibration of dibromomethane at 3062.11 cm$^{-1}$ in \autoref{tab: raman_CH2Br2} shows a higher Raman intensity than the corresponding signal of dichloromethane at 3051.13 cm$^{-1}$ in \autoref{tab: raman_CH2Cl2}, which contradicts to expectation after \autoref{eq: nu} because bromine (m = 79.9 u) has a higher atomic mass than chlorine (m = 35.5 u), which should lead to a higher reduced mass $\mu$ $^{-1}$ and therefore a lower wavenumber $\tilde{\nu}$. 
% why is that so?

% CH2Br2: 3062.11 cm$^{-1}$ in \autoref{tab: raman_CH2Cl2}
