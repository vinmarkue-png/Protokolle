...
\begin{figure}[H]
 \centering
    ...
    \caption{The volume plotted over the temperature for the three simulations.} 
    \label{fig: 3_1}
\end{figure}
...
The practical part of the experiment made a determination of the lattice energy of argon possible. It was calculated as $-\SI{8742,961}{\frac{J}{mol}}$. To verify the success of the experiment the lattice energy of the experiment was compared to one that was calculated with measurements of the same experiment under ideal sircumstances. The deviation of the two energies was 3.6\%.
