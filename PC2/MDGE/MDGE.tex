...
As in previous section discussed, the simulation-results were given in reduced temperature values that were transformed into temperature values in Kelvin to plot figure \ref{fig: 3_1}
\begin{figure}[H] 
\centering
