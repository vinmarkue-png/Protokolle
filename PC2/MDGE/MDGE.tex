...
The onset of the simulated sublimation curve was located 10 K lower, the melting and boiling points deviate due to not enough iterations in the Velocity-Verlet algorithm and approximations made in the used LJ-potential.

The sublimation enthalpy of argon was calculated as $\Delta H_\mathrm{sub} = \SI{8325.640}{\frac{J}{mol}}$, the lattice energy with experimental values as $U_\mathrm{lattice,D} = -\SI{8742,961}{\frac{J}{mol}}$ and the theoretical energy as $U_\mathrm{lattice,D} = -\SI{8441.849}{\frac{J}{mol}}.$ The deviation from the theoretical lattice energy was 3.6\%, which shows that the LJ-potential provides a good approximated value for the lattice energy of argon.
