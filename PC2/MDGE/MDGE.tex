...
\end{equation}
The calculated values of the temperature in the cryogenic cell are also listed in table \ref{tab: experiment1}.
...
The three Isobaric simulation showed the importancy of of computational accuracy leading to a curve / value much more compareable to real, experimental data. Although even the simulation with the most computational accuracy showed a strong deviation to the measured value.

In the practical part of the experiment the sublimation enthalpy of argon was determined as $\Delta H_\mathrm{sub} = \SI{8325.640}{\frac{J}{mol}}$. That made the calculation of the lattice energy $U_\mathrm{lattice,D} = -\SI{8742,961}{\frac{J}{mol}}$ possible. To verify the success of the experiment, the lattice energy calculated from the measured data was compared to the lattice energy calculated from the theoretical parameters $U_\mathrm{lattice,D} = -\SI{8441.849}{\frac{J}{mol}}.$ The deviation from the theoretical lattice energy was 3.6\%, which shows that the LJ-potential provides a good approximated value for the lattice energy of argon.
