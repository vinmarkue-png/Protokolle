...
The sublimation enthalpy can now be determined by plotting the natural logarithm of the pressure of argon in bar against $\frac{1}{\mathrm{T}}$. \autoref{fig: LogPlot} shows the the plotted data.
...
\end{equation*}
the sublimation enthalpie of argon can be calculated as $\SI{8325.640}{\frac{J}{mol}}$.\\
...
As \autoref{eq:Us1} shows, the lattice energy can be calculated with the internal energy and the vibrational energy. Therefore the vibrational energy has to be calculated, wich can be done by using \autoref{eq:Debye}. The Debye temperature $\Theta_D = \SI{85}{K}$ and the Debye funktion at $D\frac{\Theta}{T} = \SI{0.617}{}$ at 70 K are given, wich means the vibrational energy can be calculated as
\begin{align*}
    U_{\mathrm{vib}} &=\frac{9}{8}R\Theta_D + 3RT D \left(\mathrm{\frac{\Theta_D}{T}}\right)\\
