...
\end{figure}
Der Link zur erstellten Fork latutet: https://github.com/elvisgn-crt/cgl-git-uebung\\
Der Link zur Pull request lautet: https://github.com/elvisgn-crt/cgl-git-uebung/pull/1
