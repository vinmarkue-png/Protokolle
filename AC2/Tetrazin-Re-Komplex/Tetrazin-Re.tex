...
Anschließend wurde das Lösemittel unter vermindertem Druck vollständig entfernt. 
Der entstandene Feststoff wurde anschließend in einem Lösemittelgemisch aus Phosphorsäure und Wasser (150 ml; 3:2) gelöst und langsam mit Natriumnitrit (26,21 g; 380 mmol; 9,55 Äq) versetzt und über Nacht gerührt. 
Danach wurde die Lösung mit einer Natriumhydrogencarbonatlösung (300 ml) versetzt und mit Chloroform (3 x 300 ml) extrahiert. 
Nach der Extraktion wurde die Lösung über Natriumsulfat getrocknet und filtriert. Das Lösemittel des Filtrats wurde anschließend unter vermindertem Druck entfernt und der Feststoff wurde bei 80 $^\circ$C über Nacht getrocknet. 
Der pinke Feststoff wurde danach über Säulenchromatographie auf Silica (Chloroform) aufgereinigt. 
Anschließend wurden die Fraktionen zusammengeführt und das Lösemittel wurde erneut unter vermindertem Druck entfernt, wodurch 3-(pyrimidin-2-yl)-6-methyltetrazin (0,49 g; 2,82 mmol) als pinker Feststoff mit einer Ausbeute von 7,08/11,78 \% erhalten.\\
Danach wurde das Tetrazin (0,49 g; 2,82 mmol) in Chloroform (100 ml) gelöst und mit Tricarbonyldicyanomethylrheniumchlorid (0,517 g; 1,33 mmol) versetzt und bei Raumtemperatur über Nacht gerührt. 
Im Anschluss wurde das Lösemittel unter vermindertem Druck entfernt und über Säulenchromatographie auf Silica (Chloroform) gereinigt. 
Daraufhin wurde das Lösemittel erneut unter vermindertem Druck entfernt und $\mathrm{[Re(CO)_3Cl(PyrimTz)]}$ (0,643 g) wurde als rot-schwarzer Feststoff erhalten.\\
...
In einem 1l Dreihalskolben wurde 
