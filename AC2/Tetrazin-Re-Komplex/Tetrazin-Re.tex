...
\begin{figure}[H]
    ...
    \label{fig: TzNMR}
\end{figure}
Ausgehend von der in \autoref{fig: Stufe1} gezeigten Struktur des Tetrazins lassen sich die Signale wie folgt zuordnen:
Das Dublett bei 9,11 ppm mit einem Integral von 2H lässt sich den beiden aromatischen Wasserstoffatome im Pyrimidinringe an Position 4 und 6 zuordnen, da diese über eine $^3 J_{\mathrm{H-H}}$-Kopplung zum Wasserstoffatom an Position 5 koppeln ($^4 J_{\mathrm{H-H}}=$5 Hz).
Das Triplett bei 7,60 ppm (1H) kann dementsprechend dem Wasserstoffatom an Position 5 im Pyrimidinring zugeordnet werden, da es über eine $^3 J_{\mathrm{H-H}}$-Kopplung von 5 Hz zu den anderen beiden Wasserstoffatome koppelt.
Das Singulett bei 3,22 ppm mit einem Integral von 3H lässt sich den Wasserstoffatome der Methylgruppe an Position 3 im Tetrazinring zuweisen.
...
\begin{figure}[H]
    ...
    \caption{Aufgenommene UV/Vis-Spektren von \ch{[Re(CO)3Cl(N2Tz)]} (blau) und von [\ch{Re(CO)3Cl}(4,5-BCN-3-(2-pyrimidyl)-6-methylpyridazin)] (rot).}
    \label{fig: UV/Vis}
\end{figure}
...
\subsection{Phosphofluoreszenz}


\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Bilder/Fluoro.png}
    \caption{Aufgenommene Phosphofluoreszenz-Spektren von \ch{[Re(CO)3Cl(N2Tz)]} (blau) und von [\ch{Re(CO)3Cl}(4,5-BCN-3-(2-pyrimidyl)-6-methylpyridazin)] (rot).}
    \label{fig: Fluro}
\end{figure}
...
Das Lösungsmittel des Filtrats wurde anschließend unter vermindertem Druck entfernt. 
Der pinke Feststoff wurde danach über Säulenchromatographie auf Silica (Chloroform) aufgereinigt. 
Anschließend wurden die Fraktionen zusammengeführt und das Lösungsmittel wurde erneut unter vermindertem Druck entfernt, wodurch 3-Methyl-6-(pyrimidin-2-yl)-1,2,4,5-tetrazin (0,49 g; 2,82 mmol) als pinker Feststoff mit einer Ausbeute von 7,08\% erhalten.\\
...
Zum Schluss wurde der Komplex mit Bicyclononin versetzt, wobei die rotbraune Lösung gelblich und anschließend farblos wurde.
...
Im Rahmen dieses Versuchs wurde der Einkernkomplex \ch{[Re(CO)3Cl(N2Tz)]} mit dem Tetrazinligand 3-Methyl-6-(pyrimidin-2-yl)-1,2,4,5-tetrazin (N$_2$-Tz) ausgehend von 2-Cyanopyrimidin synthetisiert und über eine Klick-Reaktion zu [\ch{Re(CO)3Cl}(4,5-BCN-3-(2-pyrimidyl)-6-methylpyridazin)] umgesetzt.
