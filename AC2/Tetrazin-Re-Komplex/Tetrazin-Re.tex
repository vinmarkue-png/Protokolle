...
\begin{figure}[H]
    ...
    \label{fig: Stufe1}
\end{figure}
In der zweiten Stufe wird das Dihydrotetrazin im sauren Milieu mit \ch{NaNO2} oxidiert und nach Neutralisation mit Chloroform extrahiert, um das 3-Methyl-6-(pyrimidin-2-yl)-1,2,4,5-tetrazin (N$_2$-Tz) zu synthetisieren.
