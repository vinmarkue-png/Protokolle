...
Das Dublett bei 9,11 ppm mit einem Integral von 2H lässt sich den beiden aromatischen Wasserstoffatomen im Pyrimidinring an Position 4 und 6 zuordnen, da diese über eine $^3 J_{\mathrm{H-H}}$-Kopplung zum Wasserstoffatom an Position 5 koppeln ($^4 J_{\mathrm{H-H}}=$5 Hz).
Das Triplett bei 7,60 ppm (1H) kann dementsprechend dem Wasserstoffatom an Position 5 im Pyrimidinring zugeordnet werden, da es über eine $^3 J_{\mathrm{H-H}}$-Kopplung von 5 Hz zu den anderen beiden Wasserstoffatomen koppelt.
...
Dies lässt darauf deuten, dass bei der Komplexierung andere Komplexe als \ch{[Re(CO)3Cl(N2Tz)]} entstanden sind, die nicht durch die Säulenchromatographie entfernt werden konnten.  
Die Signale des Acetonitrils und des Polysiloxan Schlifffetts haben sich ebenfalls nicht verändert.
\subsection{UV/Vis}
...
Durch die iEDDA-Reaktion mit Bicyclononin wird die Elektronendichte im Ring vom Tetrazin zum Pyridazin erhöht, wodurch die $^3$MLCT Phosphoreszenz aktiviert wird.
...
Der Detektor ist dabei in einer geraden Linie zur Strahlungsquelle platziert, da so die Absorption durch den Unterschied der Strahlungsintensität vor und nach der Probe gemmesen werden kann.  
