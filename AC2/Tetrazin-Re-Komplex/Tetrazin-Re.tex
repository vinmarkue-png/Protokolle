...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{Bilder/Tz.png}
    \caption{Struktur des 3-Methyl-6-(pyrimidin-2-yl)-1,2,4,5-tetrazin (N$_2$-Tz) mit chemisch inäquivalenten Wasserstoffatomen.}
    \label{fig: Tz}
\end{figure}

Das Dublett bei 9,11 ppm mit einem Integral von 2H lässt sich den beiden aromatischen Wasserstoffatomen H$\mathrm{_B}$ im Pyrimidinring an Position 4 und 6 zuordnen, da diese über eine $^3 J_{\mathrm{H-H}}$-Kopplung zum Wasserstoffatom H$\mathrm{_A}$ an Position 5 koppeln ($^4 J_{\mathrm{H-H}}=$5 Hz).
...
\ch{[Re(CO)3Cl(N2Tz)]} (5 mg) wurde bei Raumtemperatur in einer Küvette in Acetonitril (2 ml) gelöst und mit Bicyclononin (5 mg) versetzt, wodurch die rotbraune Lösung gelblich und anschließend farblos wurde.\supercite{Manu}
