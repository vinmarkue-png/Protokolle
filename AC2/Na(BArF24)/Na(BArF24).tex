...
Um diese Probleme zu beheben, wurden die Phenylgruppen fluoriert, sodass die Anionen \ch{[B(C6F5)4]-} und \ch{[BArF4]-} vorliegen. 
Dabei ist das Anion \ch{[BArF4]-} besonders von Bedeutung. Es ist eines der meistverwendeten Anionen, da es leicht durch Synthesen gewonnen werden kann, seine Salze gut löslich sind und es in NMR-Spektren gut erkennbar ist. 
Außerdem finden die Alkalimetallsalze, besonders aber das Natriumsalz, Anwendung in der Methatese, als Initiator für Polymerisationen und in der Elektrochemie verwendet.\cite{Aufarbeitung}
...
Die Synthese von Natrium Tetrakis[3,5-bis(trifluormethyl)phenyl]borat wird nach dem Syntheseweg von Yakelis et al. durchgeführt. \cite{Synthese}.
...
Die nicht-luftempfindliche Aufarbeitung wird nach Martínez-Martínez et al. durchgeführt. \cite{Aufarbeitung}
