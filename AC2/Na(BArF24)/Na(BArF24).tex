...
\begin{figure}[H]
    ...
    \caption{Struktur des \ch{Na[BArF24]} mit chemisch inäquivalenten Wasserstoff- und Kohlenstoffatomen.}
    \label{fig: Struktur}
\end{figure}
...
Da \ch{Na[BArF24]} 8 aromatische Wasserstoffatome A und 4 aromatische Wasserstoffatome B aufweist, lassen sich Signale zwischen 7 und 8 ppm mit diesen Integralwerten erwarten. \\
Für das $\mathrm{^{13}C\{^1H\}}$-NMR lassen sich aufgrund der fünf chemischen inäquivalenten Kohlenstoffatome fünf Signale erwarten. 
Das Signal bei 162 ppm kann aufgrund der $^1 J_{\mathrm{B-C}}$-Kopplung zu den vier Kohlenstoffatomen 1 zugeordnet werden, die durch den Kernspin von $^{11}$B von I$=\frac{3}{2}$ zu einem Quartett mit großer Kopplungskonstante ($^1 J_{\mathrm{B-C}}=$ 50 Hz) aufspalten.\supercite{Synthese} 
Für Kohlenstoffatom 2 und 4 sind Signale bei 134,6 ppm und 117,5 ppm zu erwarten.
Kohlenstoffatom 3 koppelt über eine $^2 J_{\mathrm{C-F}}$-Kopplung mit großer Kopplungskonstant von 31,5 Hz mit den Fluoratomen und mit einer kleinen Kopplungskonstante von $^3 J_{\mathrm{B-C}}=$ 3 Hz mit dem Boratom. Deswegen lässt sich ein Quartett oder Quartett von Quartett erwarten.
Das Quartett bei 124,5 ppm kann durch die $^1 J_{\mathrm{C-F}}$-Kopplung zu Kohlenstoffatom 5 zugeordnet werden ($^1 J_{\mathrm{C-F}}$= 270 Hz). \\
...
\autoref{fig: 13C} zeigt das $\mathrm{^{13}C\{^1H\}}$-NMR Spektrum des synthetisierten Produkts.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Bilder/13C 70.png}
    \caption{Aufgenommenes $\mathrm{^{13}C\{^1H\}}$-NMR Spektrum von \ch{Na[BArF24]} in Aceton-$d_6$.}
    \label{fig: 13C}
\end{figure}

Das Signal bei 206,3 ppm und das Septett bei 29,8 ppm stammen von Aceton Rückständen.
%Quartett Signale

Die sehr große Kopplungskonstante von $^1 J_{\mathrm{C-F}}=$ 270 Hz führt dazu, dass sich die Signale der Kohlenstoffatome 3 und 5 vermischen und bei 129,8 ppm zu einem Quartett von Quartett mit annähernd 1:1:1:1 Verteilung der Intensitäten innerhalb der Quartette aufspalten.
